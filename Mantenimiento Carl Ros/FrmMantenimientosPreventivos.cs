...
{
    public partial class FrmServiciosTecnicosPreventivos : Form
    {
        ...
        public FrmServiciosTecnicosPreventivos()
        {
            InitializeComponent();
        }

        private void FrmMantenimientosPreventivos_Load(object sender, EventArgs e)
        {
            conexion = new OleDbConnection(ConexionBase.conectar());
            adaptador = new OleDbDataAdapter("SELECT * FROM MANTENIMIENTOS_ WHERE mantenimiento = 'PREVENTIVO' ", conexion);
