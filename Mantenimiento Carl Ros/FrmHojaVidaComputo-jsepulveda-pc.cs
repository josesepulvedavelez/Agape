...
namespace Mantenimiento_Carl_Ros
{
    public partial class FrmHojaVidaComputo : Form
    {
        ...
        {
            OleDbDataAdapter adaptadorUbicacion = new OleDbDataAdapter("SELECT ubicacion FROM HOJA_VIDA_COMPUTO group by ubicacion", conexion);
            DataTable dt = new DataTable();
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            ...
            {
                dgvHojaVidaComputo.Rows.RemoveAt(dgvHojaVidaComputo.CurrentRow.Index);
            }
            else if (tabControl1.SelectedIndex == 1)
            {
                dgvPieza.Rows.RemoveAt(dgvPieza.CurrentRow.Index);
            }
        ...
        private void btnActualizarMantenimiento_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                frmmantenimientoComputoActualizar.txtNo.Text = dgvMantenimiento.CurrentRow.Cells[0].Value.ToString();
                frmmantenimientoComputoActualizar.dtpFecha.Text = dgvMantenimiento.CurrentRow.Cells[1].Value.ToString();
                frmmantenimientoComputoActualizar.cboMantenimiento.Text = dgvMantenimiento.CurrentRow.Cells[2].Value.ToString();
                frmmantenimientoComputoActualizar.cboProveedor.Text = dgvMantenimiento.CurrentRow.Cells[3].Value.ToString();
                frmmantenimientoComputoActualizar.txtDescripcionActividadesRealizadas.Text = dgvMantenimiento.CurrentRow.Cells[4].Value.ToString();
                frmmantenimientoComputoActualizar.dtpfechaProximoMantenimiento.Text = dgvMantenimiento.CurrentRow.Cells[5].Value.ToString();
                frmmantenimientoComputoActualizar.txtObservaciones.Text = dgvMantenimiento.CurrentRow.Cells[6].Value.ToString();
                frmmantenimientoComputoActualizar.txtCodigoEquipo.Text = dgvMantenimiento.CurrentRow.Cells[7].Value.ToString();
                frmmantenimientoComputoActualizar.txtId.Text = dgvMantenimiento.CurrentRow.Cells[9].Value.ToString();
                frmmantenimientoComputoActualizar.cboNota.Text = dgvMantenimiento.CurrentRow.Cells[8].Value.ToString();
            }
        }
