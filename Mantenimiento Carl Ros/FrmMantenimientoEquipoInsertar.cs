...
{
    public partial class FrmMantenimientoEquipoInsertar : Form
    {
        ...
        public FrmMantenimientoEquipoInsertar()
        {
            InitializeComponent();
        }
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                comando.CommandText = "INSERT INTO MANTENIMIENTO_EQUIPO(cons, fecha, mantenimiento, proveedor, descripcion_actividades_realizadas, fecha_proximo_mto, observaciones, codigo_inventario, nota) VALUES(@cons, @fecha, @mantenimiento, @proveedor, @descripcion_actividades_realizadas, @fecha_proximo_mto, @observaciones, @codigo_inventario, @nota)";
        ...
        private void FrmMantenimientoEquipoInsertar_Load(object sender, EventArgs e)
        {
