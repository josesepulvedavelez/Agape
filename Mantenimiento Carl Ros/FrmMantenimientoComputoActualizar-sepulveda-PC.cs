    ...
    public partial class FrmMantenimientoComputoActualizar : Form
    {
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                comando.CommandText = "UPDATE MANTENIMIENTO_COMPUTO SET fecha=@fecha, mantenimiento=@mantenimiento, proveedor=@proveedor, descripcion_actividades_realizadas=@descripcion_actividades_realizadas, fecha_proximo_mto=@fecha_proximo_mto, observaciones=@observaciones, codigo_equipo=@codigo_equipo WHERE id=@id";
