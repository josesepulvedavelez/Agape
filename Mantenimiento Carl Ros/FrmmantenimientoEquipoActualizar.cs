    ...
    public partial class FrmmantenimientoEquipoActualizar : Form
    {
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                comando.CommandText = "UPDATE MANTENIMIENTO_EQUIPO SET cons=@cons, fecha=@fecha, mantenimiento=@mantenimiento, proveedor=@proveedor, descripcion_actividades_realizadas=@descripcion_actividades_realizadas, fecha_proximo_mto=@fecha_proximo_mto, observaciones=@observaciones, codigo_inventario=@codigo_inventario, nota=@nota WHERE id=@id";
        ...
        private void FrmmantenimientoEquipoActualizar_Load(object sender, EventArgs e)
        {
